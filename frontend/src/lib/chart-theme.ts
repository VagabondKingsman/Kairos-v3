...
function buildTheme() {
  ...
  // Việt Nam style: đỏ tăng / xanh giảm (giống thị trường VN)
  const upHex = dangerHex;
  const downHex = successHex;
  ...
  return {
    ...
    tooltipBg: isDark ? "rgba(10,12,16,0.95)" : "rgba(255,255,255,0.96)",
