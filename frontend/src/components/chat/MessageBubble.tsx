...
function getRetryHint(content: string): string {
  ...
  if (lower.includes("timeout") || lower.includes("timed out")) {
    return "Hết thời gian chờ. Thử đơn giản hoá chiến lược hoặc giảm số mã CK.";
  }
  if (lower.includes("api") || lower.includes("rate limit") || lower.includes("429")) {
    return "Gọi API thất bại. Vui lòng thử lại sau.";
  }
  return "Thực thi thất bại. Nhấn để thử lại.";
}
